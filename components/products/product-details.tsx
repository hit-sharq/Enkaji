     ...
     <div className="container mx-auto px-4 py-8">
       ...
       <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
               ...
               {product.images.map((image, index) => (
                 <button
                   ...
                   className={`flex-shrink-0 w-20 h-20 rounded-md overflow-hidden border-2 ${
                     selectedImage === index ? "border-enkaji-gold" : "border-border"
                   }`}
                 >
                   <Image
         ...
         <div className="space-y-6">
           <div>
             <Badge className="mb-2 bg-enkaji-gold/10 text-enkaji-gold border-enkaji-gold/20">{product.category.name}</Badge>
               ...
               <div className="flex items-center">
                 {[...Array(5)].map((_, i) => (
                   <Star
                     key={i}
                     className={`w-5 h-5 ${
                       i < Math.floor(product.avgRating) ? "text-enkaji-gold fill-enkaji-gold" : "text-muted-foreground/40"
                     }`}
                   />
                 ))}
               </div>
             ...
             <p className="text-3xl font-bold text-enkaji-gold">KES {product.price.toLocaleString()}</p>
           ...
           <div className="space-y-4">
             ...
             <div className="flex space-x-4">
               <Button
                 ...
                 className="flex-1 bg-enkaji-gold hover:bg-enkaji-gold/90 text-enkaji-ink font-semibold shadow-lg"
                 size="lg"
               >
           ...
           <Card>
             <CardHeader>
               <CardTitle className="flex items-center gap-3">
                 ...
                 <div>
                   <h3 className="font-display font-semibold">{sellerName || "Unknown Artisan"}</h3>
                   <p className="text-sm text-muted-foreground">{product.seller.sellerProfile?.location || "Kenya"}</p>
                 </div>
               </CardTitle>
             </CardHeader>
             {product.seller.sellerProfile?.bio && (
               <CardContent>
                 <p className="text-muted-foreground">{product.seller.sellerProfile.bio}</p>
               </CardContent>
             )}
           </Card>
         </div>
...
{/* Reviews Section */}
       <div className="space-y-6">
         <span className="enkaji-eyebrow mb-2 block">Testimonials</span>
...
<ProductReviewFormBanner
        ...
        <div className="mt-12">
          <span className="enkaji-eyebrow mb-2 block">More Inspiration</span>
