    ...
    <section className="py-10 md:py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-gray-600 text-sm md:text-base max-w-2xl mx-auto px-2 md:px-0">
          ...
          {stats.map((stat, index) => (
            <Card key={index} className="text-center hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-6">
                 <div className="w-16 h-16 bg-gradient-to-br from-enkaji-red to-enkaji-ochre rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="text-center mt-12">
           <Card className="bg-gradient-to-r from-enkaji-red to-enkaji-ochre text-white max-w-3xl mx-auto">
            <CardContent className="p-5 md:p-8">
              <h3 className="text-2xl font-bold mb-4">Be Part of Our Growth Story</h3>
              <p className="text-enkaji-ochre/80 mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/sign-up"
                  className="bg-white/90 text-enkaji-red px-6 py-3 rounded-lg font-semibold hover:bg-white transition-colors"
                >
                  Join as Buyer
                </a>
                <a
                  href="/sell"
                  className="bg-enkaji-brown text-white px-6 py-3 rounded-lg font-semibold hover:bg-enkaji-brown/90 transition-colors border border-enkaji-ochre/50"
                >
                  Start Selling
                </a>
              </div>
